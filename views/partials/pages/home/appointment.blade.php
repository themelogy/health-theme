            ...
            <section class="col-md-6">
                <div class="block-hourse__inner block-hourse__inner_second">
                    ...
                    <table>
                        <tbody>
                        <tr>
                            <td>{{ Carbon::now()->startOfWeek()->formatLocalized('l') }} - {{ Carbon::now()->startOfWeek()->addDay(4)->formatLocalized('l') }}</td>
                            <td><span class="line-bottom"></span></td>
                            <td>08:00 - 19:00</td>
                        </tr>
                        <tr>
                            <td>{{ Carbon::now()->startOfWeek()->addDay(5)->formatLocalized('l') }}</td>
                            <td><span class="line-bottom"></span></td>
                            <td>09:00 - 17:00</td>
                        </tr>
                        <tr>
